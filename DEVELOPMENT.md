...
关键数字:`CONCURRENCY=6`、单账号超时 8s、前端超时 12s、历史快照上限 500 条、同分钟去重、GUI 端口 8080(顺延 ≤8090)、edge-daemon 8129(HTTP API)/Edge 调试 9222、WebDAV 大文件下载/上传超时 120s(v1.4.66 由 60s 放宽)、前端同步请求超时 120s(原 90s)。
